            ...
            <div class="items-stretch grid grid-cols-1 xl:grid-cols-[1.35fr_0.85fr] gap-8 ">
                <article class="flex flex-col h-full rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl">
                    <div class="relative flex-1 aspect-video bg-slate-950">
                        <iframe src="${juego.buildUrl.split("/").pop()}" title="Juego ${juego.nombre}" class="absolute inset-0 w-full h-full border-0" allowfullscreen></iframe>
                    </div>
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/50">
                        ...
                        <a href="${juego.buildUrl.split("/").pop()}" class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900 font-bold hover:bg-blue-500 dark:hover:bg-blue-500 dark:hover:text-white transition-colors">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="rounded-2xl border border-indigo-500/20 bg-indigo-500/5 p-6">
                        ...
                        <p class="mt-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            Si el juego no carga correctamente, prueba a recargar la página o revisa tu conexión.
                        </p>

                        <p class="mt-1 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            Si el problema continúa, puedes contactar con nosotros.
                        </p>

                        <button
                            class="mt-4 w-full rounded-lg bg-slate-900 text-white py-2 text-sm font-bold hover:bg-blue-500 transition">
                            Recargar juego
                        </button>

                        <button
                            class="mt-2 w-full rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white py-2 text-sm font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition">
                            Contactar
                        </button>
                    </div>
